...
\not currently used by anything as would need to redo search to make use not clear what would be gained
...
\ ./tools/beebasm/beebasm.exe -i ./COMPRESS.asm -do ./build/ADM.ssd -boot COMPRESS -v -title COMPRESS