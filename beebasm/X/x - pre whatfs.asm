...
LDX #5:JSR diserror
LDX #6:JSR diserror
LDA #7:JSR diserror:\JMP so end
.aa:CMP #&D:BEQ cmdend:INY:LDA(blockstart),Y:CMP #32:BNE aa:
INX:BNE aa
...
\setup load command
LDX #loadcmd%:JSR initprepcmd:JSR addosparam
...
\*k.1 setup
LDX #key1cmd%:JSR initprepcmd:JSR addosparam:JSR execmd
\*repton2
...
\copy 3 0 XXXX
LDX #copycmd%
JSR initprepcmd:JSR addosparam:
...
JSR initprepcmd:JSR addosparam:JMP execmd
\JMP so end
...
.exespecial:JSR initprepcmd:JSR addosparam:JMP execmd
\JMP so end
...
LDA #35:STA &74:LDAload+1::STA &75:CLC:ADC size+1:STA &76
LDX #loadcmd%:JSR initprepcmd:JSR addosparam:JMP execmd
\utility routines
\Set cursor off
.sco
{
