...
.ds
{
STAdrstr+3:LDX drstradd:LDY drstradd+1:JMP oscli
} \rts
...
.wdn
{
LDY #92:JSR ciz:LDY #0:JSR sdz:LDY #2:JSR esa:JSR itfs:JSR clz:LDA #1:STA z:JSR mrz
JSR copystrToArray:JSR itm:LDA e:ORA #1:STA e:RTS
}
\Multiply by 10 mbt
.mbt
{
